...
*/
	...
	public ServerMain () {
    	try {
        	 ...
        	 */
            ServerFactory stub = new ServerFactory (InetAddress.getByName(serverIp), serverPort, rootDir); // a server object
            Registry registry = LocateRegistry.createRegistry(serverPort); // register port
            registry.rebind(serverName, stub); // bind to registory
