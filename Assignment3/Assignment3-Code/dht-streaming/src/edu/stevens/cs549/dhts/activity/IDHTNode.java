...
public interface IDHTNode {
	...
	/*
	 * Listening for binding transferred event.
	 */
	public final static String TRANSFER_BINDINGD_EVENT = "transfer-binding";

	public void listenOn(String key, EventListener listener) throws Failed;

	public void listenOn(String addr, String key, EventListener listener) throws Failed;
