...
public class PageRankDriver {
    ...
    static void init(String input, String output, int reducers)
        ...
        System.out.println("Init Job Started by Yang Yang");
    ...
    static void iter(String input, String output, int reducers)
            throws IOException, ClassNotFoundException, InterruptedException {
        System.out.println("Iter Job Started by Yang Yang");
    ...
    static void diff(String input1, String input2, String output, int reducers)
        ...
        System.out.println("Diff Job Part 1 Started by Yang Yang");
        Job job = Job.getInstance(); // Creates a new job
        ...
        {
            System.out.println("Diff Part 1 Complete, Part 2 Started by Yang Yang");
    ...
    static void finish(String input, String output, String name, int reducers)
            throws Exception {


        System.out.println("Finish Job Started by Yang Yang");
    ...
    public static void composite(String input, String output, String interim1,
                                 String interim2, String name, int reducers) throws Exception {
        /*
		 * TODO 
		 */
        System.out.println("Yang Yang (10412887)");
        ...
        } else // for even i, interim1 is the input directory
        {
            ...
            counter++;
            finish(interim1, output, name, reducers);
            summarizeResult(output);
        }
        System.out.println();
        ...
        if (fs.exists(diffpath)) {
            ...
            for (FileStatus file : ls) { // Modified file to support multiple reducer output files.
                if (file.getPath().getName().startsWith("part-r-00")) {
                    ...
                    if (diffcontent != null) {
                        diffcontent = diffcontent.split("\t")[1]; // my parser
